...
#ifndef TENSORFLOW_LITE_MICRO_KERNELS_LSTM_EVAL_GENERAL_IA8201_H_
#define TENSORFLOW_LITE_MICRO_KERNELS_LSTM_EVAL_GENERAL_IA8201_H_
#include <math.h>
#include <string.h>
...
#else   // #if defined(DMX1A_LSTM_OPT)
