...
int ConvFloatInt8Kernelx2(
    float* y1, const float* x2, float* y2, const float* x1, const int8_t* A,
...
TfLiteStatus PWConvFloatInt8Kernel(float* y, const float* x, const int8_t* A,
