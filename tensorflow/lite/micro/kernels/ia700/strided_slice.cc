...
// output tensor. This function is callable from both PrepareStridedSlice() and
// Eval() as long as the caller ensures the indexing tensors are present.
...
TfLiteStatus PrepareStridedSlice(TfLiteContext* context, TfLiteNode* node) {
...
// end:   0, y, 0, y
#if 1
    else if (params.start_indices_count == 4 &&
