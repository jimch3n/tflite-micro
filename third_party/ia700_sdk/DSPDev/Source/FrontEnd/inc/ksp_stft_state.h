...
* $Revision: #1 $
* $Id: //AudEngr/AlgoSW/Product/shapiro-sdk-support-TFLu-dev/SDK/Knowles_IA700_SDK/DSPDev/Source/FrontEnd/inc/ksp_stft_state.h#1 $
*
* @copyright
...
#ifndef USE_DELTAMAX_MEM_UNUSED_REMOVED
