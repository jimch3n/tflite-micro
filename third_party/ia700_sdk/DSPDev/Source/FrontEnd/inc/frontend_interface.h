...
* $Revision: #1 $
* $Id: //AudEngr/AlgoSW/Product/shapiro-sdk-support-TFLu-dev/SDK/Knowles_IA700_SDK/DSPDev/Source/FrontEnd/inc/frontend_interface.h#1 $
*
* @copyright
...
typedef struct {
	...
	TfLitePtrUnion         pOut;          ///< Output data from process, float or int8_t 
