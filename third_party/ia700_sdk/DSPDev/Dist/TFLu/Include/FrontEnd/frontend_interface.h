...
* @info
* $Author: jimchen $
* $DateTime: 2022/12/09 00:17:52 $
* $Revision: #1 $
* $Id: //AudEngr/AlgoSW/Product/shapiro-sdk-support-TFLu-dev/SDK/Knowles_IA700_SDK/DSPDev/Dist/TFLu/Include/FrontEnd/frontend_interface.h#1 $
*
* @copyright
