/************************************************************************//**
 * @file    AVL/Hemi/AMath.h
 *
 * @brief   AScalar  Math function wrapper for fr32 on HemiLite
 *
...
_AI AScalar log10(AScalar x) { return  x.f_log2() * AScalar::log10two(); } //fpmul(log2_fr(fr), log10two().fr, 0); 
_AI AScalar log(AScalar x) { return x.f_log2()* AScalar::ln2();}
_AI AScalar logf(AScalar x) { return x.f_log2()* AScalar::ln2(); }
