...
This folder contains all the HMD1A specific header files.

Files
-----
hmd1a_common_tie.h: HMD1A intrinsics interfaces generated by the Xtensa tools for use with Xtensa builds.
    There is no need to include it directly since it is included by TIE_include.h (see below).
hmd1a_version_tie.h: contains core definition item version and string. 
...
TIE_include.h: includes hemidelta_common_tie.h and extends it for functionality and ease of compilation.
