...
#ifndef __CSTUB_Xm_dmx1a_C_H__
#define __CSTUB_Xm_dmx1a_C_H__

/* Included files */
#include "cstubs_include/dmx1a_common_tie_cstubs.h"
#include "cstubs_include/dmx1a_version_tie_cstubs.h"
#include <stdlib.h>
#include <stdio.h>
#include <string.h>
...
#pragma warning( disable : 4047 4100 4244 4715)
#if defined(_WIN64) 
#error "Error: Compiling c-stub on 64 bit machines is not supported"
#endif /* _WIN64 */
...
typedef struct CSTUB_(processor) {
  ...
  CSTUB_(Lookup_Internal_t) lookup_ld;
  CSTUB_(Lookup_Internal_t) lookup_st;
...
#define table__legacy_signs CSTUB_(table__legacy_signs)
extern const unsigned int table__legacy_signs[4]; 
...
#define table__permi_values CSTUB_(table__permi_values)
extern const unsigned int table__permi_values[8]; 
#define table__msb_tbl CSTUB_(table__msb_tbl)
extern const unsigned int table__msb_tbl[16]; 
#define table__br_idx_4_tbl CSTUB_(table__br_idx_4_tbl)
extern const unsigned int table__br_idx_4_tbl[8]; 
#define table__br_idx_6_tbl CSTUB_(table__br_idx_6_tbl)
extern const unsigned int table__br_idx_6_tbl[32]; 
#define table__br_ext_6_10_tbl CSTUB_(table__br_ext_6_10_tbl)
extern const unsigned int table__br_ext_6_10_tbl[4]; 
...
static INLINE void cstub_ImportWire_Internal(CSTUB_(ImportWire_Internal_t) *iw, unsigned *data) {
  if (iw->callback == NULL) {
	...
	// When exit(1) is called when this code is run from Matlab, Matlab dies.
	// This code replaces exit(1) with debugbreak, keeping Matlab alive.
