/************************************************************************//**
 * @file    AVL/DMX1A/AComplexArray.h
 *
 * @brief   ComplexArray wrapper for DMX1A
 *
...
struct AComplexArray
{
    ...
    _AI void fill(const AComplex& x) {
        ...
        if (N & 1) {
            ...
            #pragma frequency_hint NEVER
            #endif
            vr64_storei(x.vr, (vr64*) (AScalar*) SP_dst, 0);
        }
    }
    ...
    _AI void copy(const AComplexArray& x) {
        ...
        if (N & 1) {
            ...
            #pragma frequency_hint NEVER
            #endif
            vr64_storei(vr64_loadi((const vr64*)
                                   (const AScalar*) LP_src, 0),
                        (vr64*) (AScalar*) SP_dst, 0);
        }
    }
    ...
    _AI void conj(const AComplexArray& x) {
        ...
        if (N & 1) {
            ...
            #pragma frequency_hint NEVER
            #endif
            vr64_storei(s_vnegs_hr(vr64_loadi((const vr64*)
                                              (const AScalar*) LP_src, 0), 2),
                        (vr64*) (AScalar*) SP_dst, 0);
        }
    }
    ...
    _AI void add(const AComplexArray& x, const AComplex& y) {
        ...
        UnalignedQuadLoadPointer  LP_src((const AScalar*) x.a);
        UnalignedQuadStorePointer SP_dst((AScalar*) a);
        vr128 V_src = vreplicate_hr(y.vr);
