/************************************************************************//**
 * @file    AVL\DeltaMax\AQuad.h
 *
 * @brief   AQuad wrapper for vr128 on DeltaMax
 *
...
struct AQuad
{
    ...
    _AI AComplex h0() const {AComplex z; z.fr0 = get_VRQ0(vr); z.fr1 = get_VRQ1(vr); return z;}
    _AI AComplex h1() const {AComplex z; z.fr0 = get_VRQ2(vr); z.fr1 = get_VRQ3(vr); return z;}

    _AI AQuad& set_h0(const AComplex& a) {set_VRQ0(vr, a.fr0); set_VRQ1(vr, a.fr1); return *this;}
    _AI AQuad& set_h1(const AComplex& a) {set_VRQ2(vr, a.fr0); set_VRQ3(vr, a.fr1); return *this;}
};
